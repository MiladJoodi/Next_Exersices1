    ...
    return (
        <footer className="container mx-auto flex flex-col gap-8 py-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <HiOutlineArrowUp onClick={() => goTopCtrl()} className="fixed left-4 bottom-2 cursor-pointer border-2 w-12 h-12 p-2 rounded-md bg-yellow border-black transition-all duration-500 bg-yellow-500 hover:bg-indigo-400 hover:text-white" />
            </div>
        </footer>
    );
}
